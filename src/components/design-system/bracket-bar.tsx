...
/**
 * BracketBar — 누진 구간에서 내가 어디에 있는지 (CTveiw result/BracketBar 포팅)
 *
 * 종합소득세는 8구간, 법인세는 4구간이다 — 개수를 가정하지 않고 넘겨받은
 * 배열을 그대로 그린다. 가로 스크롤 칩으로 두면 폰에서 앞쪽 6%·15% 칩이
 * 잘려 보이는데 사용자는 스크롤된다는 걸 알아채지 못한다. 그래서 줄바꿈으로
 * 전부 보여 주고(8구간은 430px 에서 2줄) 적용 구간만 크게 강조한다.
 *
